...
export const NewsItems: NewsItem[] = [
  ...
  }*/
  {
    ...
    items: [
      ...
      { text: <>Major <B href='https://twitter.com/fugoku/status/1756553038293303434'>performance optimizations</B>: runs faster, saves power, saves memory</> },
  ...
  },
  {
    ...
    items: [
      ...
      { text: <><Link href='https://duardo-ai.com'>Website</Link>: official downloads</> },
      { text: <>Easier Vercel deployment, documented <Link href='https://github.com/fugoku/duardo-ai/issues/276#issuecomment-1858591483'>network troubleshooting</Link></>, dev: true },
    ],
  },
  {
    versionCode: '1.7.0',
