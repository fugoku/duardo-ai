...
buildType && console.log(`   🧠 duardo-ai: building for ${buildType}...\n`);
...
let nextConfig = {
  ...
  webpack: (config, _options) => {
    ...
    if (typeof config.optimization.splitChunks === 'object' && config.optimization.splitChunks.minSize) config.optimization.splitChunks.minSize = 40 * 1024;
