  ...
  return <>
    ...
    <FormControl orientation='horizontal' sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <Typography level='body-xs'>
        <Link href='https://github.com/fugoku/duardo-ai/issues/208' target='_blank'>Split Chats</Link>
        {' · '}<Link href='https://github.com/fugoku/duardo-ai/issues/359' target='_blank'>Draw App</Link>
        {' · '}<Link href='https://github.com/fugoku/duardo-ai/issues/354' target='_blank'>Call AGI</Link>
        {' · '}<Link href='https://github.com/fugoku/duardo-ai/issues/282' target='_blank'>Persona Creator</Link>
        {' · '}<Link href='https://github.com/fugoku/duardo-ai/issues/192' target='_blank'>Auto Diagrams</Link>
