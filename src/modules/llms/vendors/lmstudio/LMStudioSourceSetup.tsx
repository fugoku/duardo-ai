  ...
  return <>
    ...
    <Typography level='body-sm'>
      ...
      for local models. Please refer to our <Link
        level='body-sm' href='https://github.com/fugoku/duardo-ai/blob/main/docs/config-local-lmstudio.md' target='_blank'>configuration guide</Link> for
    ...
    <FormInputKey
      ...
      required noKey
      rightLabel={<Link level='body-sm' href='https://github.com/fugoku/duardo-ai/blob/main/docs/config-local-lmstudio.md' target='_blank'>Learn more</Link>}
